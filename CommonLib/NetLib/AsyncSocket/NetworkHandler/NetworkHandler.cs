...
namespace NetLib
{
    ...
    {
        void Debug(string _msg, params object [] _param);
        void Warn(string _msg, params object[] _param);
        void Error(string _msg, params object[] _param);
        void Info(string _msg, params object[] _param);
        void Fatal(string _msg, params object[] _param);
        void Exception(string logMessage, System.Exception exceptionData);
    }

    public enum NETCLIENT_TYPE
    {
        CS = PacketLib.PacketDefine.CS_Server_Packet_Head_Size,
        S2S = PacketLib.PacketDefine.S2S_Packet_Head_Size,
    }
    ...
    public partial class NetworkHandler
    {
        ...
        SocketAsyncEventArgsPool receiveEventPool;
        SocketAsyncEventArgsPool sendEventPool;
        ...
        public delegate void OnConnect_CallBack(NetToken _netToken);
        ...
        public void ConnectServer(SocketAsyncEventArgs e)
        {
            if (e.SocketError != SocketError.Success)
            {
                ...
                {
                    logger?.Error("Not Found Remote Connect Info, Full Restart Server");
                }
                return;
            }
