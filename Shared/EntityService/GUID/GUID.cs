...
namespace EntityService
{
    ...
    public class GUID
    {
        ...
        static public bool operator ==(GUID a, GUID b)
        {
            if (a?.Value == b?.Value)
                return true;
            return false;
    ...
    static public class GUIDGen
    {
        ...
        static public void Init(ushort machineId)
        {
        ...
        static private GUID CreateGUID(DateTime now)
        {
            ...
            ulong timestamp_bits = (ulong)timeStamp << 22;
